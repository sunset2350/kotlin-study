...
// 코틀린에서는 클래스는 기본적으로 public -> 가져다쓰는게 가능함
// 기본적으로 final -> 상속(extends)해서 사용이 불가능
fun main() {
...
//    person.name = "John" // 변경 불가
    ...
    // named parameter
    val person2 = Person(age = 40, name = "John")

    // default value가 있는 매개변수 제외
    val person3 = Person("Jack")
    person3.age = 35

    println(Calculator.add(2,3))

    val calc = Calculator("공학계산기")
    calc.printName()
